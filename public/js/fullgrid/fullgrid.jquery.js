    ...
    $.fn.extend({
        ...
        fullgrid: function (opt) {
            ...
            _private.ajaxExport = function(oSettings,params,doc,btn){
                ...
                var filters = (oSettings.pFilterCols !== undefined)?Tools.en(oSettings.pFilterCols):'';
            ...
            _private.clearFilter = function (oSettings, idCont) {
                $('#' + idCont).parent('th').find('select.operador1,select.operador3').val('LIKE');
                $('#' + idCont).parent('th').find('select.operador2').val('AND');
                $('#' + idCont).parent('th').find('input:text').val('');
                oSettings.pFilterCols = _private.prepareFilters(oSettings);
                oSettings.pDisplayStart = (_private.sgbd == 'sql') ? 1 : 0;
                _private.sendAjax(oSettings);
            };
            ...
            _private.addSearchCols = function (oSettings) {
                ...
                if (_private.ifDatePicker) {
                    ...
                    $('.datepickerGrid').mask('9999-99-99');
                }
