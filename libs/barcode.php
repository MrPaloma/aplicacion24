...
// For demonstration purposes, get pararameters that are passed in through $_REQUEST or set to the default value
...
$print = (isset($_REQUEST["print"])&&$_REQUEST["print"]=='true'?true:true);
$sizefactor = (isset($_REQUEST["sizefactor"])?$_REQUEST["sizefactor"]:"1");
