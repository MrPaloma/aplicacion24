                    ...
                    <div class="lv-header-section">
                        ...
                        <section style="margin-bottom: 0px" class="padding-10">
                            ...
                            <label class="input col-6"> 
                                <input name="txt_serie_g" id="txt_serie_g" type="text" class="input-xs lv-disabled" disabled="true"/>
                            </label>
                        </section>
                        <section style="margin-bottom: 0px" class="padding-10">
                ...
                <div class="row padding-10">
                    <section class="col col-6" style="margin-bottom: 0px">
                        <section style="margin-bottom: 0px" class="padding-10">
                            ...
                            <label class="select col-4" id="d_send_sunat"> 
        ...
        <js>
            $.validate({
                ...
                submitHandler: function () {
                    Obj.Facturacion.VentaAx.postEditGuia(__PK__);
                }
            });
        </js>
