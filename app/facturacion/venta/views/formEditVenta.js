        ...
        <section class="col col-12">
            <div class="smart-form lv-header-section">
                <div class="alert alert-success no-margin fade in">
                    ...
                    <span class="pull-right" id="sp_caja" style="margin-top: -6px;"><b class="tr-language" data-tr="_132"></b></span>
                </div>
                ...
                <div class="row padding-10">
                    ...
                    <section class="col col-3" style="margin-bottom: 0px">
                        ...
                        <label class="input"> 
                            <input name="txt_tipo_doc" id="txt_tipo_doc" type="text" class="input-xs lv-disabled" readonly="true"/>
                        </label>
                    </section>
                    <section class="col col-2" style="margin-bottom: 0px">
                        <label class="label tr-language" data-tr="serie"></label>
                        <label class="input"> 
                            <input name="txt_serie" id="txt_serie" type="text" class="input-xs lv-disabled" readonly="true"/>
                        </label>
                    </section>
                    <section class="col col-2" style="margin-bottom: 0px">
                        <label class="label tr-language" data-tr="num_doc"></label>
                        <label class="input"> 
                            <input name="txt_num_doc" id="txt_num_doc" type="text" class="input-xs lv-disabled" readonly="true"/>
                        </label>
                    </section>                    
                    <section class="col col-2" style="margin-bottom: 0px">
                    ...
                    <section class="col col-3" style="margin-bottom: 0px">
                        ...
                        <label class="input"> 
                            <input name="txt_tipo_moneda" id="txt_tipo_moneda" type="text" class="input-xs lv-disabled" readonly="true"/>
                        </label>
                    </section>
                </div>
                ...
                <div class="row padding-10">
                    <section class="col col-6" style="margin-bottom: 0px">
                        ...
                        <label class="input"> 
                            <input name="txt_cliente" id="txt_cliente" type="text" class="input-xs lv-disabled" readonly="true"/>
                        </label>
                    </section>
                    ...
                    <section class="col col-2" style="margin-bottom: 0px">
                        ...
                        <label class="input"> 
                            <input name="txt_forma_pago" id="txt_forma_pago" type="text" class="input-xs lv-disabled" readonly="true"/>
                        </label>
                    </section>
        ...
        <div class="smart-form">
            <div class="row">
                <section class="col col-8">
                    ...
                    <br/>
                    <div class="lv-header-section-info">
                        <div class="alert alert-info no-margin fade in">
                            <i class="fa-fw fa fa-money"></i> <span class="tr-language" data-tr="_200"></span>               
                        </div>

                        <div class="row">
                            <section class="col col-6">
                                <section style="margin-bottom: 0px" class="padding-10">
                                    <label class="label tr-language" data-tr="_201"></label>
                                    <label class="input"> 
                                        <input class="input-lg" name="txt_recibido" id="txt_recibido" />
                                    </label>
                                </section>
                            </section>
                            <section class="col col-6">
                                <section style="margin-bottom: 0px" class="padding-10">
                                    <label class="label tr-language" data-tr="_202"></label>
                                    <label class="input"> 
                                        <input class="input-lg lv-disabled" name="txt_vuelto" id="txt_vuelto" disabled="true"/>
                                    </label>
                                </section>
                            </section>
                        </div> 
        ...
        <js>
            $.validate({
                ...
                submitHandler: function () {
                    Obj.Facturacion.VentaAx.postEditVenta(__PK__);
                }
            });
        </js>
