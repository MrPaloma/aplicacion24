                ...
                <div class="panel panel-default" style="padding: 0px !important;padding-left:0px !important;">
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordionq" href="#collapseOne-1" aria-expanded="false" class="collapsed"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> 
                                <i class="fa fa-fw fa-minus-circle txt-color-red"></i> <span class="tr-language" data-tr="_082"></span> </a></h4>
                    </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div id="tb_all" class="table-responsive">
                                <table class="table table-bordered" border="1">
                                    <thead>
                                        <tr>
                                            <th colspan="7" class="text-center tr-language" data-tr="_140"></th>
                                        </tr>
                                        <tr>
                                            ...
                                            <th class="text-center tr-language" data-tr="razon_social" style="width: 280px;"></th>
                                ...
                                <table class="table table-bordered" border="1">
                                    <thead>
                                        <tr>
                                            <th class="text-center tr-language" data-tr="_241" colspan="2"></th>
                                            <th class="text-center tr-language" data-tr="_242" colspan="2"></th>
                                        </tr>
                                        <tr>
                                ...
                                <table class="table table-bordered" border="1">
                                    <thead>
                                        <tr>
                                            <th colspan="5" class="text-center tr-language" data-tr="_244"></th>
                                        </tr>
                                        <tr>
                                ...
                                <table class="table table-bordered" border="1">
                                    <thead>
                                        <tr>
                                            <th colspan="4" class="text-center tr-language" data-tr="_120"></th>
                                        </tr>
                                        <tr>
                                ...
                                <table class="table table-bordered" border="1">
                                    <thead>
                                        <tr>
                                            <th colspan="4" class="text-center tr-language" data-tr="_119"></th>
                                        </tr>
                                        <tr>
