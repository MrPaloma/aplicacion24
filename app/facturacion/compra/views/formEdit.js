                        ...
                        <div class="row padding-10">
                            ...
                            <section class="col col-3" style="margin-bottom: 0px">
                                ...
                                <div class="inline-group">
                                    <label class="radio">
                                        <input name="erd_pagado" id="erd_pagado1" type="radio" value="1"/>
                                        <i></i> <span class="tr-language" data-tr="_061"></span>
                                    </label>
                                    <label class="radio">
                                        <input name="erd_pagado" id="erd_pagado0" type="radio" value="0"/>
                            ...
                            <section class="col col-2" style="margin-bottom: 0px">
                                ...
                                <label class="input"> 
                                    <input name="etxt_tipo_cambio" id="etxt_tipo_cambio" type="text" class="input-xs lv-disabled"/>
                                </label>
                            </section>
                        </div>
