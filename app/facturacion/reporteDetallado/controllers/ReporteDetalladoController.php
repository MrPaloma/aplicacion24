...
* Descripcion : ReporteDetalladoController.php
* ---------------------------------------
*/ 

namespace Facturacion\ReporteDetallado\Controllers;
   
use \Vendor\Controller;
use \Facturacion\ReporteDetallado\Filters\ReporteDetalladoFilter;
use \Dompdf\Dompdf;

class ReporteDetalladoController extends \Facturacion\ReporteDetallado\Models\ReporteDetalladoModel {
    
    use Controller {
        Controller::__construct as private __cConstruct;
    }
    use ReporteDetalladoFilter {
        ReporteDetalladoFilter::__construct as private __fConstruct;
    }
