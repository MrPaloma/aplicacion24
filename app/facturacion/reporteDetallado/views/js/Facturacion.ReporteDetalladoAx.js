 ...
 * Descripcion : ReporteDetalladoAx.js
 * ---------------------------------------
 */
"use strict";
Exe.include([
...
$$.Facturacion.ReporteDetalladoAx = class ReporteDetalladoAx extends $$.Facturacion.ReporteDetalladoRsc {

    constructor() {
        super();
        this._controller = 'reporteDetallado:';
        this._alias = Exe.getAlias();
        this._dmain = `#${this._alias}${APP_CONTAINER_TABS}`; /*contenedor principal de opcion*/
        this._tour = Obj.Facturacion.ReporteDetalladoTour;
        this._idGrid = null;
        this._idFormTicket = `#${this._alias}formTicket`;
        this._idFormReporteDetallado = `#${this._alias}formReporteDetallado`;
        ...
        this._grid = (tk) => {
            ...
            $(`#${this._alias}grid`).fullgrid({
                ...
                tColumns: [
                    ...
                    {title: APP_ETIQUET.tipo_comprobante, field: 'tipo_comprobante', class: "text-center", width: 80, sortable: true, filter: {type: 'text'}},
                    {title: APP_ETIQUET._026, field: 'serie', class: "text-center", width: 120, sortable: true, filter: {type: 'text'}},
                    {title: APP_ETIQUET._012, field: 'catalogo', class: "text-center", width: 120, sortable: true, filter: {type: 'text'}},
                    {title: APP_ETIQUET._013, field: 'cantidad', class: "text-center", width: 120, sortable: true, filter: {type: 'text'}},
                    {title: APP_ETIQUET.precio_unitario, field: 'precio_unitario', class: "text-center", width: 120, sortable: true, filter: {type: 'text'}},
                    {title: APP_ETIQUET._017, field: 'total_detalle', class: "text-center", width: 120, sortable: true, filter: {type: 'text'}},
                    
                    {title: APP_ETIQUET.cliente, field: 'razon_social', class: "text-center", width: 120, sortable: true, filter: {type: 'text'}},
                    {title: APP_ETIQUET._264, field: 'nombre', class: "text-center", width: 120, sortable: true, filter: {type: 'text'}}
