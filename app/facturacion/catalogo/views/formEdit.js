    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title tr-language" data-tr="edit_bien_servicio"></h4>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-5">
                        <select id="lst_tipo" name="lst_tipo" class="chosen">
                            <option value=""></option>
                            <option value="B" class="tr-language" data-tr="bien"></option>
    ...
    <js>
        $.validate({
            ...
            submitHandler: function () {
                    Obj.Facturacion.CatalogoAx.postEdit(__PK__);
            }
        });
    </js>
</form>