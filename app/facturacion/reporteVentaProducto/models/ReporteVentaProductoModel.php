...
* Descripcion : ReporteVentaProductoModel.php
* ---------------------------------------
*/ 

namespace Facturacion\ReporteVentaProducto\Models;
  
class ReporteVentaProductoModel extends \Vendor\DataBase {
    ...
    protected function spGrid() {
        $query = "CALL sp_facturacion_reporte_venta_producto_grid (:idCliente,:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
