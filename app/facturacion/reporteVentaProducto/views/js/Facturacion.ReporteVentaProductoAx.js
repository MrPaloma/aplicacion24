 ...
 * Descripcion : ReporteVentaProductoAx.js
 * ---------------------------------------
 */
"use strict";
Exe.include([
...
$$.Facturacion.ReporteVentaProductoAx = class ReporteVentaProductoAx extends $$.Facturacion.ReporteVentaProductoRsc {

    constructor() {
        super();
        this._controller = 'reporteVentaProducto:';
        this._alias = Exe.getAlias();
        this._dmain = `#${this._alias}${APP_CONTAINER_TABS}`; /*contenedor principal de opcion*/
        this._tour = Obj.Facturacion.ReporteVentaProductoTour;
        this._idGrid = null;
        this._idFormTicket = `#${this._alias}formTicket`;
        this._idFormReporteVentaProducto = `#${this._alias}formReporteVentaProducto`;
            ...
            $(`#${this._alias}grid`).fullgrid({
                ...
                sAxions: {
                    ...
                    buttons: [{
                            button: APP_BTN.PDF,
                            ajax: {
                                fn: "Obj.Facturacion.ReporteVentaProductoAx.getPDF",
