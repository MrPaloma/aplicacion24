...
* Descripcion : ProveedorModel.php
* ---------------------------------------
*/ 

namespace Facturacion\Proveedor\Models;
  
class ProveedorModel extends \Vendor\DataBase {
    ...
    protected function spGrid(){
        $query = "CALL sp_facturacion_proveedor_grid (:idCliente,:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    protected function mantenimiento() {
        $query = "CALL sp_facturacion_proveedor_mantenimiento ("
                . ":cliente,"
                . ":flag,"
                . ":key,"
                . ":tipo_doc,"
    ...
    protected function qFindProveedor() {
        $query = "
        SELECT 
