...
* Descripcion : ProveedorAx.js
* ---------------------------------------
*/ 
"use strict";

$$.Facturacion.ProveedorAx = class ProveedorAx extends $$.Facturacion.ProveedorRsc {

    constructor() {
        super();
        this._controller = 'proveedor:';
        this._alias = Exe.getAlias();
        this._dmain = `#${this._alias}${APP_CONTAINER_TABS}`; /*contenedor principal de opcion*/
        this._tour = Obj.Facturacion.ProveedorTour;
        ...
        this._grid = (tk) => {
            $(`#${this._alias}grid`).fullgrid({
                ...
                tButtons: [{
                        button: APP_BTN.NEW,
                        event: 'Obj.Facturacion.ProveedorAx.formNew'
                    }],
                ...
                sAxions: {
                    ...
                    group: [{
                            buttons: [{
                                    button: APP_BTN.EDT,
                                    ajax: {
                                        fn: "Obj.Facturacion.ProveedorAx.formEdit",
                                        serverParams: "id_proveedor"
                                    }
                                }, {
                                    button: APP_BTN.DEL,
                                    ajax: {
                                        fn: "Obj.Facturacion.ProveedorAx.postDelete",
                                        serverParams: "id_proveedor"
                                    }
                                }]
                        }]
        ...
        this._extraerDataDNI = (doc) => {
            let path = 'https://dniruc.apisperu.com/api/v1/dni/' + doc + token;
        ...
        this.send({
            ...
            response: (data) => {
                ...
                if (data.ok_error != 'error') {
                    ...
                    if ($('._proveedor').length > 0) {//recargar en lst
                        Tools.addOption('._proveedor', data, () => {
                            $('._proveedor').val(data.id);
                            $('._proveedor').trigger("chosen:updated");
                        });
                    }
