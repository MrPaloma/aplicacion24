...
* Descripcion : NotaDebitoRsc.js
* ---------------------------------------
*/ 
"use strict";

$$.Facturacion.NotaDebitoRsc = class NotaDebitoRsc extends Resource {
    ...
    addButtons() {
        $.fn.appButton.get({
            ...
            notext: true,
            keymnu: this._alias,
            btns: [{keybtn: APP_BTN.FVER, type: 'button', evts: [{click: 'Obj.Facturacion.NotaDebitoAx.verFactura'}]}]
        });
        $.fn.appButton.get({
            container: `#${this._alias}btn_dale`,
            keymnu: this._alias,
            btns: [{keybtn: APP_BTN.XONT, type: 'button', evts: [{click: 'Obj.Facturacion.NotaDebitoAx.getFactura'}]}]
        });
        $.fn.appButton.get({
            ...
            items: [
                {
                    ...
                    container: `#${this._alias}d_tipo_nota_debito`,
                    required: true,
                    attr: {
                        id: `${this._alias}lst_tipo_nota_debito`,
                        name: `${this._alias}lst_tipo_nota_debito`,
                        class: 'form-control'
                    },
                    default: null
                },
...
//                },
    ...
    setDocumento(data) {
        ...
        Tools.setDataForm(this._idFormNotaDebito, {
            alias: this._alias,
            elements: [
