    ...
    <form>
                ...
                <div class="row padding-10">
                    <div class="smart-form">
                        ...
                        <section class="col col-4" style="margin-bottom: 0px">
                            <label class="label tr-language" data-tr="_192"></label>
                            <label class="select" id="d_tipo_nota_debito"> 
                                <select name="lst_tipo_nota_debito" id="lst_tipo_nota_debito"/>
                            </label>
                        </section>
                        <section class="col col-2" style="margin-bottom: 0px">
        ...
        rules: {
            ...
            submitHandler: function () {
                Obj.Facturacion.NotaDebitoAx.postNotaDebito(__PK__);
            }
            });
        </js>
