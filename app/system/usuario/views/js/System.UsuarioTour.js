"use strict";
$$.System.UsuarioTour = class UsuarioTour {
        ...
        var tour = new Tour({
            steps: [
                {
                    ...
                    element: `#btnEexcel_${this._gridUsuario}`,
                    ...
                    element: `#tr_${this._gridUsuario}_0 div.btn-group`,
                    ...
                    element: `#btn_axion_${this._gridUsuario}_0_0_0`,
                    ...
                    element: `#btn_axion_${this._gridUsuario}_0_0_1`,
                    ...
                    element: `#btn_axion_${this._gridUsuario}_0_0_2`,
                    ...
                    element: `#btn_axion_${this._gridUsuario}_0_0_3`,
                    ...
                    element: `#btn_axion_${this._gridUsuario}_0_0_4`,
                    ...
                    element: `#btnRefresh_${this._gridUsuario}`,
            ...
            onNext: (tour) => {  
                ...
                if(tour._current == 2 || tour._current == 3 || tour._current == 4 || tour._current == 5 || tour._current == 6){
                    $(`#tr_${this._gridUsuario}_0 div.btn-group`).addClass('open');
                }else{
                    $(`#tr_${this._gridUsuario}_0 div.btn-group`).removeClass('open');
                }
            }
        });
        tour.init();
