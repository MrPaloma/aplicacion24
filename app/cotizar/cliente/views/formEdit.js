    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><span class="tr-language" data-tr="_127"></span>: <span id="n_coti"></span></h4>
            </div>
            <div class="modal-body form-horizontal">

                <div class="form-group">
                    <label class="col-lg-2 control-label tr-language" data-tr="cliente"></label>
                    <div class="col-lg-10" id="d_cliente">
    ...
    <js>
        $.validate({
            ...
            submitHandler: function () {
                    Obj.Cotizar.ClienteAx.postEdit(__PK__);
            }
        });
    </js>
</form>